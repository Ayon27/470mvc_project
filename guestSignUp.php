...
if (isset($_POST['submit'])) {
    ...
    if (duplicateExists('guest', 'email', $email, $conn)) {
        $email = "Email already in use!";
        $continue = false;
    }

    if ($continue) {
        $query = "INSERT INTO guest (email, pass, name, country, state, address, phone) values (?, ?, ?, ?, ?, ?, ?);";
        ...
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
            ...
            <a style="text-decoration: none; color: black; font-size: 16px; border-bottom: 1px solid grey" href="index.php">Home</a></span>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <span class="navbar-text actions"> <a class="login" href="guestlogin.php">Log In</a><a class="btn btn-light action-button" role="button" href="#">Sign Up</a></span>
                </div>
            </div>
        </nav>
    </div>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" action="" onsubmit="return checkPass()">
                <h2 class="text-center"><strong>Create</strong> an acount</h2>
