    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
        ...
        <a style="text-decoration: none; color: black; font-size: 16px; border-bottom: 1px solid grey" href="index.php">Home</a></span>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <a class="login"
                   href="hostlogin.php">Log In</a>
                    <a class="btn btn-light action-button" role="button" href="hostSignUp.php">Sign Up</a></span>
            </div>
        </div>
    </nav>
</div>
...
<div class="login-clean">
    <form method="post" action="">
        ...
        <p class="text-center text-secondary">as a host</p>
